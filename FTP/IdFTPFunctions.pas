  ...
  begin
    ...
    try
      ...
      begin
        ...
        tmReCon:=CoDecModify(ReadString('09'),True);
        StType:= CoDecModify(ReadString('10'),True);
        StType2:=CoDecModify(ReadString('11'),True);
      end;
    finally
      CloseKey;
      Free;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        WriteString('09', CoDecModify(tmReCon,False));
        WriteString('10', CoDecModify(StType,False));
        WriteString('11', CoDecModify(StType2,False));
      end;
    finally
      CloseKey;
      Free;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        WriteBinaryData('Value', PChar(Key)^, length(key));
      end;
    finally 
      CloseKey;
      Free;
