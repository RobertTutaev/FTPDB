...
Const
  ...
  Mess21= 'Отсутствует подключение к БД!';
  Mess22= 'Не удалось подключиться к FTP-серверу!';
  Mess23= 'Определение области видимости выполнено!'+#13#10+
          'Для обновления списка файлов нажмите кнопку "Применить".';
  Mess24= 'Определение области видимости запрещено!';
  Mess25= 'Ошибка ввода в дипазоне дат!'+#13#10+'Bыбраны все записи!';
  Mess26= 'Ошибка ввода в дипазоне размеров!'+#13#10+'Bыбраны все записи!';
  Mess27= 'Ошибка ввода в названии файла!'+#13#10+'Bыбраны все записи!';
