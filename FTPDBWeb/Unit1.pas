...
Const
  ...
  Mess13='Программа находится в режиме демо-версии!'+#13#10+#13#10+
         'Максимальное количество пользователей 1.'+#13#10+
         'Разрешенный FTP-сервер/Пользователь: ';
