...
begin
  ...
  DataSet.FieldValues['pport']:=0;
  DataSet.FieldValues['readtimeout']:=0;
  IBTableS_PROXYTYPE.First;
  DataSet.FieldValues['pproxytype']:=IBTableS_PROXYTYPE.FieldValues['kod'];
end;
...
begin
  ...
  DataSet.FieldValues['DIRECTION']:=2;
end;
